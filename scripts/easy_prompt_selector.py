...
class PromptSelectorExtensionScript(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        """
        # Not shown on "i2i" page
        if (is_img2img):
            return None

        # Define a "Reload" button
        reload_button = self._define_reload_button()
    ...
    def _process_prompts(self, sd_processing_obj):
        ...
        for [prompt_list_attr_name, prompt_attr_name, prompt_param_name] in prompt_type_definitions:
            ...
            if shared.opts.eps_enable_save_raw_prompt_to_png_info == True and decoding_required:
    ...
    def _define_reload_button(self):
        #
        reload_button = gradio.Button('🔄', variant='secondary', elem_id='easy_prompt_selector_reload_button')
